...
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
#define MAX_CURRENT 8.6             /* max current value, Amps */
...
#define FREQ_START_UP_DURATION    (u16) 2400 //in msec
#define FINAL_START_UP_SPEED      (u16) 900 //Rotor mechanical speed (rpm)
...
#define FIRST_I_STARTUP           (u16) 1881
#define FINAL_I_STARTUP           (u16) 2361
...
#define SLESS_I_ALIGNMENT           (u16) 7412
...
#define RELIABILITY_HYSTERESYS    (u8)  300//30
//Minimum Rotor speed to validate the start-up
#define MINIMUM_SPEED_RPM             (u16) 580	 //580
