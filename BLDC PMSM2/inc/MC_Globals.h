...
typedef	union _SysState_
{	
	u8  Sys_State;
	struct{    
	   unsigned fcommuiok    :1;
	   unsigned Moto_Enable   :1;
	   unsigned DgDevErr     :1;
	   unsigned CanOnline    :1;       
	   unsigned Disp1Err     :1; 
	   unsigned Disp2Err     :1; 
	}SysState;
}uSysState;
typedef	union _MotoMode_
{	
	u8  Moto_Mode;
	struct{    
	   unsigned Changedirec  :1;
	   unsigned CardDevErr   :1;
	   unsigned DgDevErr     :1;
	   unsigned CanOnline    :1;       
	   unsigned Disp1Err     :1; 
	   unsigned Disp2Err     :1; 
...
extern uMotoMode bMotoMode; 
extern uSysState  bSysState;
extern s32 POSSION_ACT,POSSION_SET;
extern u16 COUNT,COUNT_T;
extern s16 MOTOR_VEL;
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
