...
/*****************************  Encoder settings ******************************/
#define ENCODER_PPR           (u16)(500)//(u16)(400)   // number of pulses per revolution

/* Define here the absolute value of the application minimum and maximum speed 
                                                                   in rpm unit*/
#define MINIMUM_MECHANICAL_SPEED_RPM  (u32)0//60   //rpm
...
/*************************** Alignment settings *******************************/
//Alignemnt duration
#define T_ALIGNMENT           (u16) 20    // Alignment time in ms
...
#define I_ALIGNMENT           (u16) 7412//7412
