...
#define	POLE_PAIR_NUM  (u8) 3  //	(u8) 4   0 .    /* Number of motor pole pairs */
#define RS           1.54//1.5 //   2.10            /* Stator resistance , ohm*/
#define LS           0.0800 //  0.0005// 0.0006        /* Stator inductance , H */
...
#define MOTOR_VOLTAGE_CONSTANT      23.4  //Volts RMS ph-ph /kRPM
