...
#define BUS_ADC_CONV_RATIO			0.045//0.93	0.042	//DC bus voltage partitioning ratio
...
#define PID_SPEED_KP_DEFAULT      (s16)200
...
#define PID_TORQUE_KP_DEFAULT  (s16)578       
#define PID_TORQUE_KI_DEFAULT  (s16)176
...
#define PID_FLUX_KP_DEFAULT  (s16)578 
#define PID_FLUX_KI_DEFAULT  (s16)76
#define PID_FLUX_KD_DEFAULT  (s16)100
...
#define SQUARE_WAVE_PERIOD   (u16)80000 //in msec
