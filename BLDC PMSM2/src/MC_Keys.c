...
//#define KEY_UP_BIT  GPIO_Pin_14

//#define KEY_DOWN_PORT GPIOF
//#define KEY_DOWN_BIT  GPIO_Pin_15

//#define KEY_RIGHT_PORT GPIOF
//#define KEY_RIGHT_BIT  GPIO_Pin_13

//#define KEY_LEFT_PORT GPIOF//CRE上LEFT不用
//#define KEY_LEFT_BIT  GPIO_Pin_12
						 
//#define KEY_SEL_PORT GPIOF
//#define KEY_SEL_BIT  GPIO_Pin_11
#define KEY_UP_PORT GPIOD
#define KEY_UP_BIT  GPIO_Pin_0

#define KEY_DOWN_PORT GPIOD
#define KEY_DOWN_BIT  GPIO_Pin_1

#define KEY_RIGHT_PORT GPIOC
#define KEY_RIGHT_BIT  GPIO_Pin_11

#define KEY_LEFT_PORT GPIOC//CRE上LEFT不用
#define KEY_LEFT_BIT  GPIO_Pin_12
...
{
 /* "DOWN" key is pressed */
   if(!GPIO_ReadInputDataBit(KEY_DOWN_PORT, KEY_DOWN_BIT))
   {
           if (hSpeed_Reference >= -MOTOR_MAX_SPEED_HZ)
              {
                hSpeed_Reference -= SPEED_INC_DEC;
              }
		 while(!GPIO_ReadInputDataBit(KEY_DOWN_PORT, KEY_DOWN_BIT));
   }
    /* "UP" key is pressed */
   if(!GPIO_ReadInputDataBit(KEY_UP_PORT, KEY_UP_BIT))
   {
           if (hSpeed_Reference <= MOTOR_MAX_SPEED_HZ)
              {
                hSpeed_Reference += SPEED_INC_DEC;
              }
	   while(!GPIO_ReadInputDataBit(KEY_UP_PORT, KEY_UP_BIT));
   }
   /*
	 if(!GPIO_ReadInputDataBit(KEY_SEL_PORT, KEY_SEL_BIT))
     {
	    ...
	    while(!GPIO_ReadInputDataBit(KEY_SEL_PORT, KEY_SEL_BIT));
	 } */
