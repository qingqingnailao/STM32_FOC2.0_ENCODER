...
#define POSITION_SAMPLING_TIME	 1 
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
static u16 hPossitionMeas_Timebase_500us = SPEED_SAMPLING_TIME;
static u16 hPossition_Timebase_500us = POSITION_SAMPLING_TIME;										  
...
if(hPossitionMeas_Timebase_500us !=0)
 {
   	hPossitionMeas_Timebase_500us--;
 }
 else
 {
    hPossitionMeas_Timebase_500us = SPEED_SAMPLING_TIME;  
    time++;
    time1++;
 ...
 if( hPossition_Timebase_500us  !=0)
 {
   	 hPossition_Timebase_500us --;
 }
 else
 {
     hPossition_Timebase_500us  = POSITION_SAMPLING_TIME;  
