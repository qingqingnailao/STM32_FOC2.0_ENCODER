  ...
  { 
    ...
    switch(bPresent_Visualization)
    {
        ...
        switch(bMenu_index)
        {
          case(P_SPEED_MENU):
...
#else        
            {
              ...
              for( i=0; i<5; i++)
              {						  // 320 -
                LCD_DisplayChar(Line4, (u16)((16*(18-i))),'-');
              }
            }
#endif         
      ...
      case(VISUALIZATION_5):
        ...
        LCD_DisplayChar(Line5, 16*CHAR_11, (u8)(((temp%1000)/100)+0x30));
        LCD_DisplayChar(Line5, 16*CHAR_12, (u8)(((temp%100)/10)+0x30));
        LCD_DisplayChar(Line5, 16*CHAR_13, (u8)((temp%10)+0x30));
        
        temp = MCL_Compute_Temp(); 
        LCD_DisplayChar(Line7, 16*CHAR_6, (u8)(((temp%1000)/100)+0x30));
        LCD_DisplayChar(Line7, 16*CHAR_7, (u8)(((temp%100)/10)+0x30));
        LCD_DisplayChar(Line7, 16*CHAR_8, (u8)((temp%10)+0x30));
      ...
      case(VISUALIZATION_7):
        ...
        else
        {
          ...
          {//Under or over voltage
             ...
             LCD_DisplayChar(Line6, 16*CHAR_11, (u8)(((temp%1000)/100)+0x30));
             LCD_DisplayChar(Line6, 16*CHAR_12, (u8)(((temp%100)/10)+0x30));
             LCD_DisplayChar(Line6, 16*CHAR_13, (u8)((temp%10)+0x30));
             LCD_DisplayChar(Line6, 16*CHAR_14, ' ');
             LCD_DisplayChar(Line6, 16*CHAR_15, 'C');
          }
          else 
          {           
            if (bPresent_Visualization != bPrevious_Visualization)
            ...
            LCD_DisplayChar(Line6, 16*CHAR_13, (u8)((temp%10)+0x30)); 
            LCD_DisplayChar(Line6, 16*CHAR_14, ' ');
            LCD_DisplayChar(Line6, 16*CHAR_15, 'V');             
          }          
          LCD_ClearLine(Line8);
          LCD_ClearLine(Line9);
        }
    ...
    case(VISUALIZATION_10):
      ...
      switch(bMenu_index)
      {
        case(DAC_PB0_MENU):
          ...
          LCD_DisplayStringLine(Line4, ptr);	
         // LCD_DisplayStringLine(Line4, "123abc");
...
{ u32 i;
  ...
  if (number<0)     
  {								 //320-
    LCD_DisplayChar(Line,(u16)( 16*bFirstchar), '-');
    number = -number;
  }
  else 
  {								//320-
  ...
  {										// *24 320 -
    ...
    LCD_DisplayChar(Line, (u16)((16*(bFirstchar+5-i))),
                                        (u8)(((number%(10*h_aux))/h_aux)+0x30));          
    h_aux *= 10;
  }							 //320-
  LCD_DisplayChar(Line,(u16)((16*(bFirstchar+1))), (u8)(((number/10000))+0x30));
}    
