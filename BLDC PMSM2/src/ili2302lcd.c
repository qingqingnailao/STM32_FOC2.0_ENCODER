...
/* Start Initial Sequence ----------------------------------------------------*/
 ...
 // LCD_WriteReg(R3,  0x1020); /* set GRAM write direction and BGR=1. */
...
/* Power On sequence ---------------------------------------------------------*/
 ...
 // LCD_WriteReg(R33, 0x0000); /* GRAM Vertical Address */
  LCD_WriteReg(R32, 0x00ef); /* GRAM horizontal Address */
...
* Input          : - Xpos: specifies the X position. X:0-239 the line,0LINE IS THE FIRST LINE
*                  - Ypos: specifies the Y position. Y:319-0 THE COLOUMN,0 IS RIGHT
* Output         : None
* Return         : None
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : LCD_DrawChar		 //横向从左到右，从上到下取模
* Description    : Draws a character on LCD.
* Input          : - Xpos: the Line where to display the character shape.
*                    This parameter can be one of the following values:
*                       - Linex: where x can be 0..239
*                  - Ypos: start column address.319-0
...
*                    This parameter can be one of the following values:
*                       - Linex: where x can be 0..239
                   - Column: start column address. 319-0
...
* Input          : - Xpos: specifies the X buttom left position.0-239
*                  - Ypos: specifies the Y buttom left position. 319-0
...
* Input          : - Xpos: specifies the X position.0-240
*                  - Ypos: specifies the Y position.319-0
*                  - Length: line length.
*                  - Direction: line direction.
*                    This parameter can be one of the following values: Vertical 
*                    or Horizontal. 0,hengxiang 1.zongxiang
* Output         : None
* Return         : None
*******************************************************************************/
...
* Input          : - Xpos: specifies the X position. 0-239	,circle center
*                  - Ypos: specifies the Y position.319-0
*                  - Radius: ban jing.
* Output         : None
* Return         : None
...
/*******************************************************************************
* Function Name  : LCD_DrawOne_HZ
* Description    : Displays one chinese HZ.
* Input          : - Xpos: specifies the X position. 0-239	,circle center
*                  - Ypos: specifies the Y position.319-0
*                  	-Width: the width by pix(unit),the value should be 8 times
					- Height:the height by pix.
					*da: the Start Addr of the HZ
* Output         : None
* Return         : None
*******************************************************************************/	  
void LCD_DrawOne_HZ(u8 Xpos, u16 Ypos, u8 Width,u8 Height,u8 *da )
{
  u32 index = 0, i = 0,j;
  u8 Xaddress = 0;
...
* Description    : Displays a unsigned 16-bit number
* Input          : - Xpos: specifies the X position. 0-239	,circle center
*                  - Ypos: specifies the Y position.319-0
*                  	-da: the data to display
* Output         : None
* Return         : None
*******************************************************************************/
void LCD_Draw_NUM(u8 Xpos, u16 Ypos, u16 da )
{
  u8 x;
  x=da/10000;  
  LCD_DisplayChar(Xpos,Ypos,x+0x30);	 
  x=da/1000%10;
  LCD_DisplayChar(Xpos,Ypos-16,x+0x30);
  x=da/100%10;
  LCD_DisplayChar(Xpos,Ypos-32,x+0x30);
  x=da/10%10;
  LCD_DisplayChar(Xpos,Ypos-48,x+0x30);
  x=da%10;
  LCD_DisplayChar(Xpos,Ypos-64,x+0x30);	  
}
/*******************************************************************************
...
void LCD_CtrlLinesConfig(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOE |
